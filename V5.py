...
class TweetAnalyser():
    ...
    def tweets_to_data_frame(self, tweets, lang='en'):
        ...
        df['sentiment'] = npy.array([self.analyze_sentiment(tweet.full_text, lang)for tweet in tweets])
