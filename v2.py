...
class TwitterClient():
    ...
    def __init__(self, twitter_user=None):  # if none your own profile
...
# # API reference regarder sur le site tweepy.org pour ajouter des fonctions
...
if __name__ == "__main__":
    ...
    # twitter_client = TwitterClient('Carlito_delaf')
